...
export default function SearchResultsPageClient() {
    ...
    useEffect(() => {
        ...
        fetchPosts();
    }, [ageFrom, ageTo, dateFrom, dateTo, keyword1, keyword2, keyword3, isImmediate]);
        ...
        <section className="max-w-lg mx-auto p-6">
            ...
            <div className="mb-6 p-4 bg-gray-100 rounded border">
                ...
                <ul className="text-gray-700 space-y-1">
                    ...
                    <li>
                        日付: {isImmediate ? '今すぐ' : `${formatDate(dateFrom) ?? '指定なし'} ～ ${formatDate(dateTo) ?? '指定なし'}`}
                    </li>
                    <li>
                        キーワード: {[keyword1, keyword2, keyword3].filter(k => k).length > 0
