...
export default function SearchPage() {
    ...
    return (
        <section className="flex flex-col items-center p-6">
            <h1 className="w-full max-w-md text-left text-2xl font-bold mb-4">
                投稿検索
            </h1>
            ...
            <form onSubmit={handleSearch} className="w-full max-w-md space-y-6">
                ...
                <div className="flex gap-6">
                    <div className="flex flex-col flex-1 text-left">
                        <label htmlFor="ageFrom" className="mb-1 font-semibold">
                            年齢（から）
                        </label>
                        <select
                            id="ageFrom"
                    ...
                    <div className="flex flex-col flex-1 text-left">
                        <label htmlFor="ageTo" className="mb-1 font-semibold">
                            年齢（まで）
                        </label>
                        <select
                            id="ageTo"
                ...
                <div className="flex items-center gap-2">
                    ...
                    <label
                        ...
                        className={`font-semibold ${
                            isImmediateDisabled ? 'text-gray-400 cursor-not-allowed' : ''
                        }`}
                ...
                <div className="flex gap-6">
                    <div className="flex flex-col flex-1 text-left">
                        <label htmlFor="dateFrom" className="mb-1 font-semibold">
                            日付（から）
                        </label>
                        <input
                            type="date"
                    ...
                    <div className="flex flex-col flex-1 text-left">
                        <label htmlFor="dateTo" className="mb-1 font-semibold">
                            日付（まで）
                        </label>
                        <input
                            type="date"
                ...
                <div className="flex gap-4">
                    ...
                    <button
                        type="button"
                        onClick={handleClear}
                        className="flex-1 py-3 bg-gray-300 text-gray-800 rounded hover:bg-gray-400 transition"
                    >
                        入力クリア
                    </button>
                </div>
