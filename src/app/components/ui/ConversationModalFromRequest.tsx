...
export default function ConversationModal({ requestId, onClose }: ConversationModalProps) {
    ...
    useEffect(() => {
        async function fetchData() {
            setLoading(true);
            try {
                const res = await fetch(`/api/requests/${requestId}/getConversationFromRequest`);
